...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Prasad Thorve
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">👨‍💻 Skilled MERN stack web developer passionate about crafting user-friendly web apps and delivering high-quality solutions. 💻🚀</p> 
